...
void move_to_saltbag(void)
{
    ...
    move_forward(25, 10);
    turn_right(25,6);//robot will now attempt to change direction, so the scoop can face the back
    check_heading(44.8);
    check_x_minus(25.4);//since robot is backwards, use opposite RPS functions
    check_y_plus(15.8);
}

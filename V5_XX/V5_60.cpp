...
void position_to_buttons_final(void)
{
    ...
    /*check_y_plus(50.199);
    turn_left(25, 2.5); //turn on a 45 degree angle toward buttons
    check_heading(44.199);//correct to avoid snow
    move_forward(25,8);
    check_heading(53.699);//correct to avoid fence
    move_forward(25,10); //modified version with increased severity of angles*/
    move_forward(25,10);
...
void scoop(void)
{
    ...
    Sleep(1000);
    /*move_forward(-30,9.5);*/
    //customized move forward to give more power to one of the motors in case of uneven driving
    encode = 9.5 * counts_per_rotation;
    //Reset encoder counts
    right_encoder.ResetCounts();
    left_encoder.ResetCounts();
    //Set both motors to desired percent

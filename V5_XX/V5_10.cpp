...
void position_to_buttons_final(void)
{
    ...
    move_forward(-25,5); //move away from crank
    check_y_plus(45.9); //needs to be determined experimentally, just an approximation
...
void poke(void)
{
    ...
    saltservo.SetDegree(scoopangle-20);
    check_heading(224.1);
    move_forward(-30, 6);
    move_forward(30, 4);
    saltservo.SetDegree(startangle);
...
void move_down_ramp(void)
{
    ...
    check_x_plus(30.4);
    turn_right(30, 3);
    //robot should be at bottom of ramp
    check_y_minus(40.199);
    check_heading(180);
    move_forward(15,15);//drives slowly down ramp
    //position to oil switch
    turn_right(25, 10);//turn 180 degrees
